...
//go:generate ucloud-gen-go-api UDB DescribeUDBInstanceByParamGroup
...
func (c *UDBClient) NewDescribeUDBInstanceByParamGroupRequest() *DescribeUDBInstanceByParamGroupRequest {
	req := &DescribeUDBInstanceByParamGroupRequest{}
...
func (c *UDBClient) DescribeUDBInstanceByParamGroup(req *DescribeUDBInstanceByParamGroupRequest) (*DescribeUDBInstanceByParamGroupResponse, error) {
	var err error
	var res DescribeUDBInstanceByParamGroupResponse

	err = c.Client.InvokeAction("DescribeUDBInstanceByParamGroup", req, &res)
	if err != nil {
		return &res, err
	}
