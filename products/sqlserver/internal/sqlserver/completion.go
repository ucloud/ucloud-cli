...
var dbVersionList = []string{"sqlserver-2017", "sqlserver-2019", "sqlserver-2022"}

// getAllVPCIns returns VPC list for the given project and region.
...
// getAllVPCIdNames returns VPC ID/Name pairs for shell completion.
...
// getAllSubnets returns subnet list for the given VPC, project and region.
...
// getAllSubnetIDNames returns Subnet ID/Name pairs for shell completion.
