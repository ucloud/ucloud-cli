...
// newDelete 构建 uddos overseas ip delete 命令
//
// @Brief  构建海外高防 ip delete 子命令，调用 DeleteBGPServiceIP
//
...
func newDelete(ctx *cli.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "delete",
		Short:   "Delete an overseas BGP high-protection IP",
		Long:    "Delete a BGP DDoS protection IP from the specified overseas service",
		Example: "  ucloud uddos overseas ip delete --resource-id nap-xxxxx --defence-ip 1.2.3.4",
